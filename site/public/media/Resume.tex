...
\section{Projects}
%=================
\subsection{Personal Site with Photography Portfolio {\normalfont $|$ \href{https://github.com/Hugoyhu/hugohu.me}{\textit{GitHub}}} \hfill 2026}
\begin{itemize}
    \item Built personal site with a photography portfolio with nextJS, Supabase, Cloudinary CDN
    \item Designed a built-in inventory tracker for electronic components
\end{itemize}
